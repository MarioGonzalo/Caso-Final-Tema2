...
public int aletas;
    ...
    public static class PezGlobo extends Peces {
        public PezGlobo() {
    ...
    public static class PezPayaso extends Peces {
        public PezPayaso() {
    ...
    public static class MantaRaya extends Peces {
        public MantaRaya() {
    ...
    public static class CaballitoMar extends Peces {
        public CaballitoMar() {
